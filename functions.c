...
*@types: lists ofthe arguments
*@buffer: buffer arrays to handle the print
*@flags: calculates the active flags
*@width: the width
*@precision: precision spefication
*@size: size specifier
*Return: the size specificier
*/
...
*@types: lists of all the arguments
*@bufffer: array to handle print
*@flags: calculates active flags
*@width: get width
*@precision: precision specification
*@size: size specifier
